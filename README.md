...
<p><strong>Design-studio site driven by kinetic typography.</strong></p>

<p>
  <a href="https://bswxyz.github.io/formwork-monolith/"><img alt="Live demo" src="https://img.shields.io/badge/demo-live-8b5cf6?style=flat-square&labelColor=1a1a1a"></a>
...
<p>
  <a href="https://bswxyz.github.io/formwork-monolith/"><b>Live demo</b></a>
  &nbsp;·&nbsp;
  <a href="https://bswxyz.github.io/formwork-monolith/guide/">Build notes</a>
  &nbsp;·&nbsp;
  <a href="https://parable-three.vercel.app/templates">More templates</a>
</p>

<a href="https://bswxyz.github.io/formwork-monolith/">
  <img src=".github/preview.jpg" alt="Monolith — live preview" width="100%">
</a>
...
```bash
npx degit bswxyz/formwork-monolith my-app
```


**Live demo → https://bswxyz.github.io/formwork-monolith/** · [How it was built](https://bswxyz.github.io/formwork-monolith/guide/)
...
```bash
gh repo create my-site --template bswxyz/formwork-monolith --public --clone
cd my-site
